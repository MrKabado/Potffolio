  ...
  const offerData = [
    {
      ...
      description: "I create websites that match your brand’s personality and goals, blending appealing visuals with functionality to keep visitors engaged.",
      icon: <PaintBrushIcon className='w-8 md:w-9'/>,
      style: "shadow-md shadow-gray-300 p-2 rounded-xl transition-all duration-400 hover:-translate-y-3 hover:bg-[#1E293B] hover:text-white cursor-default",
    },
    {
      title: "Responsive and Cross-Device Layouts",
      description: "Your website will look great and work smoothly on desktops, tablets, and mobile devices, ensuring a consistent experience for all users.",
      icon: <DevicePhoneMobileIcon className='w-8 md:w-9'/>,
    },
    {
      title: "User-Centered Interface Design",
      description: "I design layouts and navigation that make it easy for visitors to find what they need, improving overall usability and satisfaction.",
      icon: <UserCircleIcon className='w-8 md:w-9'/>,
    },
    {
      title: "Website Maintenance and Updates",
      description: "I provide regular updates, content changes, and technical support to keep your website secure, up-to-date, and running smoothly as your business evolves.",
      ...
      <div className='grid grid-col gap-5 my-5 border-gray-400 border-b-4 pb-10 md:grid-cols-2'>
        {
          offerData.map((data, index) => (
            <div key={index} className='shadow-md shadow-gray-300 p-2 rounded-xl transition-all duration-400 hover:-translate-y-3 hover:bg-[#1E293B] hover:text-white cursor-default'>
              {data.icon}
